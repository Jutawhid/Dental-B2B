      ...
      <div class="content-wrapper">
        <div class="content-body">
          <div id="user-case">
            ...
            <div class="col-12">
              <table id="datatable" v-if="users?.length > 0">
                <thead>
                  <tr>
                    <th>Case ID</th>
                    <th>Patient</th>
                ...
                <tbody class="d-lg-flex flex-wrap admin">
                  <tr
...
#datatable .admin .name span.designation {
  color: #131313;
  font-size: 14px;
  font-weight: normal;
}
...
#datatable .options .icon-message-circle {
  content: '\e890';
  font-size: 20px;
  margin-top: auto;
  position: static;
