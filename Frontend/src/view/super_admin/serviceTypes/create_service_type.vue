      ...
      <div class="content-wrapper">
        <div class="row">
          <div class="col-lg-4 my-1">
            <h1 class="text-bold-700 mb-0 headerTXT">Create Service Type</h1>
          </div>
        ...
        <div class="col-lg-8 px-lg-0 py-1">
          <p>You can create a new service type here.</p>
          <!--  Section -->
          <div class="card">
            <div class="card-body">
              <Form
              ...
              >
                ...
                <div class="col-lg-6">
                  <div class="form-group">
                    ...
                    <Field
                      ...
                      class="form-control"
                      placeholder="e.g.: 01"
                      v-model="this.userData.priority"
                      required
                    />
                ...
                <div class="col-lg-6">
                  <div class="form-group">
                    ...
                    <!-- <ErrorMessage name="example9" class="error-feedback" /> -->
