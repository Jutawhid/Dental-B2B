      ...
      <div class="content-wrapper">
        <div class="content-body">
          <div id="user-profile">
            ...
            <profileDetals :user_details="user_details" />
            <!-- End Profile Details -->
                  ...
                  <div class="card top-m">
                    <div class="card-body">
                      ...
                      <div class="tab-content">
                        ...
                        >
                          <!-- Service Content -->
                          <servicesDetals :user_details="user_details" />
                          <!--End Service Content -->
                        </div>
                        <!-- Service Tab End -->
                        ...
                        >
                          <!-- Training Content -->
                          <trainingDetals :user_details="user_details" />
...
import servicesDetals from './service/serveiceDetails';
