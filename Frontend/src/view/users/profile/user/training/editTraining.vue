              ...
              <div class="content-body">
                ...
                >
                  ...
                  <input
                    ...
                    v-model="trainings.id"
                  />
                  <input
                    type="text"
                    class="form-control mb-3"
                    v-model="trainings.name"
                    id="training_name"
                  />
                  ...
                  <div>
                    ...
                    <label class="custom-file-label mb-3" for="customFile"
                      >Choose file</label
                    >

                    <img
                      :src="trainings.file_path"
...
export default {
  ...
  methods: {
    editTraining() {
      ...
      axios
        .get('trainings/edit-training/' + id, {
          headers: {
