<template>
  <div>
    <table id="labDatatable">
      ...
      <tbody>
        <tr class="TR d-flex flex-wrap" v-for="lab in labs.data" :key="lab.id">
          <td class="img">
            <img
            ...
            <img
              v-if="lab.profile_image"
              class="imgAvatar"
              :src="this.baseImg + '/' + lab.profile_image"
              alt="img"
            />
          </td>
...
#labDatatable .icon-message-circle {
  content: '\e890';
  font-size: 20px;
  margin-top: 6px;
  position: absolute;
