      ...
      <div class="content-wrapper">
        <div class="content-body">
          ...
          <div class="row">
            ...
            <div class="col-lg-9">
              <table id="datatable2" v-if="this.caseList?.length > 0">
                <thead>
                  <tr
                    class="
                      d-md-flex
                ...
                <tbody>
                  ...
                  >
                    ...
                    <td align="center" aria-label="Start Date">
                      {{ moment(item.created_at).format('MMMM Do YYYY') }}
                    </td>

                    <td align="center" aria-label="Created By">
              ...
              <p
                ...
                v-if="!loading && this.caseList?.length == 0"
              >
...
export default {
  name: 'AllCases',
  mounted() {
    caseAPI.getCaseListForAdmin().then(
      res => {
        // set -> case list
  ...
  methods: {
    ...
    searchByStatus(serviceStatus) {
      ...
      $('#datatable2').DataTable().column(3).search(serviceStatus).draw();
    },
    caseFilter() {
      ...
      if (status) {
        $('#datatable2').DataTable().column(3).search(status).draw();
      }
