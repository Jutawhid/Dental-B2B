  ...
  <div class="row">
    <div class="col-lg-9">
      ...
      <div class="table-responsive">
        <table id="labTable" v-if="labs?.data?.length > 0">
          <thead>
            <tr>
          ...
          <tbody>
            ...
            <td class="td_name col-lg-12 mt-2 mt-lg-0">
              ...
              <td class="d-none">{{ lab.ratings }}</td>
              <td
                class="
                  col-lg-3 col-md-3
                  px-0
              ...
              >
                ...
                <button
                  class="chatIcon"
                  v-if="userRole === 1"
                  @click="confirmDelete(lab.user_id)"
                >
        ...
        <p class="alert alert-info" v-if="!loading && labs?.data?.length === 0">
          No data found
        </p>
      </div>
    </div>
  ...
  methods: {
    ...
    applyFilter() {
      if (this.selectedRating) {
        $('#labTable').DataTable().column(3).search(this.selectedRating).draw();
      }

      if (this.serviceName) {
        $('#labTable').DataTable().column(0).search(this.serviceName).draw();
      }
    ...
    resetLocation() {
      ...
      $('#labTable').DataTable().column(3).search('').draw();
      $('#labTable').DataTable().column(0).search('').draw();
