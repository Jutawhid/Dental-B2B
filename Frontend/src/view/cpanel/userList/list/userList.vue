...
export default {
  ...
  mounted() {
    ...
    if (this.currentUser) {
      this.role = this.currentUser.role.role_id;
    }
...
@media screen and (min-width: 768px) and (max-width: 1000px) {
  #user-profile #userList .nav.nav-tabs .nav-item .nav-link {
    padding: 5px 15px 10px !important;
  }
}
@media screen and (max-width: 767px) {
  #user-profile li.nav-item {
    min-width: auto;
    text-align: center;
  }
  ul.col-lg-9.nav.nav-tabs {
    display: flex;
    flex-wrap: nowrap;
...
#user-profile #userList .nav.nav-tabs {
  margin-bottom: 0;
}
</style>
